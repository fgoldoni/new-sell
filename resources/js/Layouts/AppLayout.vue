                ...
                >
                    ...
                    <div class="ml-6 flex space-x-4 items-center">
                        ...
                        <a
                            ...
                            :class="[
                                scrolledFromTop ? 'py-1' : 'py-1.5',
                                'uppercase rounded-md bg-rose-700 px-3 text-xs font-semibold text-white shadow-sm hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600',
                            ]"
                        >
                            <svg
                                v-if="processing"
