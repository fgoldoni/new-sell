        ...
        <div class="py-10 mx-auto max-w-7xl md:px-8">
            ...
            >
                ...
                >
                    ...
                    <h2
                        class="max-w-md mx-auto mb-6 text-4xl font-semibold md:leading-tight md:text-5xl"
                    >
                ...
                <div class="w-full mt-7 md:w-1/2 md:mt-0">
                    <img :src="$page.props.team.event.avatar" class="w-full" />
                </div>
            </div>
            ...
            <div class="flex flex-col mt-10 md:flex-row md:mt-8 md:space-x-8">
                ...
                >
                    ...
                    >
                        <h3
                            class="text-4xl font-semibold leading-none md:text-5xl"
                        >
                            Switch to iPhone
                        </h3>
                    ...
                    <img :src="$page.props.team.event.avatar" class="w-2/3" />
                </div>
                <div
                ...
                >
                    <img :src="$page.props.team.avatar" class="w-20 h-auto" />
                    <div class="flex flex-col px-10 space-y-6 md:px-8">
                        <h3
                            class="text-3xl font-semibold leading-none md:text-4xl"
                        >
                            Privacy
                        </h3>
                        <p class="text-xl font-light text-gray-800">
