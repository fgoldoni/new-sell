                ...
                <div class="mx-auto grid grid-cols-2 gap-16">
                    <div class="space-y-6 text-center lg:ml-0 md:ml-10">
                        ...
                        >
                            ...
                            />
                            <svg
                                class="absolute inset-0 w-full h-full text-pink-500 transform scale-150 fill-current opacity-10"
                                viewBox="0 0 200 200"
                    ...
                    <div class="space-y-6 text-center lg:ml-0 md:ml-10">
                        ...
                        >
                            ...
                            />
                            <svg
                                class="absolute inset-0 w-full h-full text-yellow-500 transform scale-150 fill-current opacity-10"
                                viewBox="0 0 200 200"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <path
