                            ...
                            >
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    ...
                                    <input
                                        ...
                                        id="phone"
                                        v-model="form.phone"
                                        :class="`block py-2.5 ps-6 pe-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-${$page.props.team.color}-500 focus:outline-none focus:ring-0 focus:border-${$page.props.team.color}-600 peer`"
                                        placeholder=" "
                                        required
                                    />
                                    <label
                                        for="phone"
                                        :class="`absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-placeholder-shown:start-6 peer-focus:start-0 peer-focus:text-${$page.props.team.color}-600 peer-focus:dark:text-${$page.props.team.color}-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto`"
                                    >
                                        {{ __("Phone") }}
                                    </label>
                                </div>
    ...
    try {
        ...
        await authStore
            ...
            .then(async (response: any) => {
                ...
                if ((cart.value.properties?.reservation === 'after') && usePage().props.team.transfer) {
